				     ...
				     int *ifidx, int *sock)
{
	...
	*ifidx = nl80211_create_iface(bss, drv, buf, NL80211_IFTYPE_MONITOR, NULL,
				      0, NULL, NULL, 0);
...
int nl80211_send_monitor(struct i802_bss *bss,
			 ...
			 int encrypt, int noack)
{
	...
	res = nl80211_create_monitor_interface(bss, drv, &ifidx, &sock);
	if (res < 0)
		return res;
